#!/usr/bin/env bash
# Trainrobot — lokaler APK-Bau (identisch zu CI: Gradle 8.10.2, SDK 35).
# Voraussetzung: build-env unter ../build-env (Gradle + android-sdk),
# sonst BUILD_ENV überschreiben. Ausgabe: app/build/outputs/apk/release/Trainrobot.apk
set -euo pipefail
...
echo ">> Sim-Assets verifizieren (offizieller microduck-simulator-Dist)"
...
APK="$ROOT/app/build/outputs/apk/release/Trainrobot.apk"
