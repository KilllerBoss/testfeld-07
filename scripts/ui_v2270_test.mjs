...
check('VERSION 2.28.1 in main.js', mainSrc.includes("const VERSION = '2.28.2'"));
check('versionCode 43 / versionName 2.28.1', gradleSrc.includes('versionCode 43') && gradleSrc.includes('versionName "2.28.2"'));
