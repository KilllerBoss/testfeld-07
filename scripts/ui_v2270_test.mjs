...
check('VERSION 2.28.4 in main.js', mainSrc.includes("const VERSION = '2.28.4'"));
check('versionCode 45 / versionName 2.28.4', gradleSrc.includes('versionCode 45') && gradleSrc.includes('versionName "2.28.4"'));
