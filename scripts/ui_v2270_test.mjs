...
check('VERSION 2.28.3 in main.js', mainSrc.includes("const VERSION = '2.28.3'"));
check('versionCode 44 / versionName 2.28.3', gradleSrc.includes('versionCode 44') && gradleSrc.includes('versionName "2.28.3"'));
