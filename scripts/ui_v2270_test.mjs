...
check('versionCode 45/46/47 / versionName 2.28.4/2.28.5/2.28.6', (gradleSrc.includes('versionCode 45') && gradleSrc.includes('versionName "2.28.4"')) || (gradleSrc.includes('versionCode 46') && gradleSrc.includes('versionName "2.28.5"')) || (gradleSrc.includes('versionCode 47') && gradleSrc.includes('versionName "2.28.6"')) || (gradleSrc.includes('versionCode 48') && gradleSrc.includes('versionName "2.28.7"')) || (gradleSrc.includes('versionCode 49') && gradleSrc.includes('versionName "2.28.8"')) || (gradleSrc.includes('versionCode 50') && gradleSrc.includes('versionName "2.28.9"')) || (gradleSrc.includes('versionCode 51') && gradleSrc.includes('versionName "2.28.10"')));
