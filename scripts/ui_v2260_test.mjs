...
check('main.js: VERSION 2.26.0 + getLivePrompt + Trainings-%-Loop + fmtIntD', mainJs.includes("const VERSION = '2.26.0';") && mainJs.includes('getLivePrompt:') && mainJs.includes('ardyTrainFill') && mainJs.includes('function fmtIntD'));
...
check('build.gradle: versionCode 38 / versionName 2.26.0', gradle.includes('versionCode 38') && gradle.includes('versionName "2.26.0"'));
