...
console.log('\n[6] Verdrahtungs-Pins (main.js)');
{
  ...
  ok(mainJs.includes("const VERSION = '2.28.5';") || mainJs.includes("const VERSION = '2.28.6';") || mainJs.includes("const VERSION = '2.28.7';") || mainJs.includes("const VERSION = '2.28.8';") || mainJs.includes("const VERSION = '2.28.9';") || mainJs.includes("const VERSION = '2.28.10';") || mainJs.includes("const VERSION = '2.28.11';"), 'VERSION 2.28.5-2.28.11');
  const gradle = await readFile(path.join(ROOT, 'app/build.gradle'), 'utf8');
  ok((gradle.includes('versionCode 46') && gradle.includes('versionName "2.28.5"')) || (gradle.includes('versionCode 47') && gradle.includes('versionName "2.28.6"')) || (gradle.includes('versionCode 48') && gradle.includes('versionName "2.28.7"')) || (gradle.includes('versionCode 49') && gradle.includes('versionName "2.28.8"')) || (gradle.includes('versionCode 50') && gradle.includes('versionName "2.28.9"')) || (gradle.includes('versionCode 51') && gradle.includes('versionName "2.28.10"')) || (gradle.includes('versionCode 52') && gradle.includes('versionName "2.28.11"')), 'versionCode 46-52 / versionName 2.28.5-2.28.11');
}
