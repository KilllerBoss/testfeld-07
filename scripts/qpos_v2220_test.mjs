...
console.log('\n[5] Verdrahtung (main.js / index.html / ai.js / Doku / Notebook / Gradle)');
{
  ...
  ok(main.includes("VERSION = '2.22.0'") || main.includes("VERSION = '2.27.0'") || main.includes("VERSION = '2.27.1'") || main.includes("VERSION = '2.28.0'") || main.includes("VERSION = '2.28.1'") || main.includes("VERSION = '2.28.3'"), 'VERSION (>= 2.22.0-Pin)');
