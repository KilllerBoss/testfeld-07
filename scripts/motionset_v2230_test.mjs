...
check('main.js: VERSION >= 2.26.0 + Teacher-Verdrahtung (v2.26.0-Pin)', (mainJs.includes("const VERSION = '2.26.0';") || mainJs.includes("const VERSION = '2.27.0';") || mainJs.includes("const VERSION = '2.27.1';")) && mainJs.includes('initTeacherUI();') && mainJs.includes('downloadMotionSetBg();') && mainJs.includes('wireTeacher(t);'));
check('build.gradle: versionCode 38 / versionName 2.26.0 (v2.26.0-Pin)', (gradle.includes('versionCode 38') || gradle.includes('versionCode 39') || gradle.includes('versionCode 40')) && gradle.includes('applicationId "com.lertrain.app"'));
