...
| CONTROL | Steuerung, Buttons, Makros, Szenarien, Sturz-Verhalten, FPV, setAppearance, setUI, ⭐ MOTION-KI (motionKi — Motion-Wiedergabe + Steuer-Mix + Geist-Pause + Clip-Wechsel) |
